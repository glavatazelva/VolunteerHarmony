...
public class OrganizationRemoveVolunteerController {
    private static final Logger logger = LoggerFactory.getLogger(OrganizationRemoveVolunteerController.class);
    @FXML
    private Label title;
    @FXML
    ...
    public void initialize() {
        ...
        volunteerAddColumn.setCellFactory(param -> new TableCellWithMinusButton());

    }

    public static void removeVolunteerToOrganization(String email){
        ...
        if(typeOfAcc.equals(FilePathsEnum.CHARITY_FILE_PATH.getType())){
            if(DatabaseUtils.updateVolunteerListByRemoving(activeUserEmail,FilePathsEnum.CHARITY_FILE_PATH,volunteerID))
                OtherUtils.removedVolunteerToOrganization();
        }

        else if(typeOfAcc.equals(FilePathsEnum.DISASTER_RELIEF_FILE_PATH.getType())){
            if(DatabaseUtils.updateVolunteerListByRemoving(activeUserEmail,FilePathsEnum.DISASTER_RELIEF_FILE_PATH,volunteerID))
                OtherUtils.removedVolunteerToOrganization();
        }

        else if(typeOfAcc.equals(FilePathsEnum.ANIMAL_WELFARE_FILE_PATH.getType())){
            if(DatabaseUtils.updateVolunteerListByRemoving(activeUserEmail,FilePathsEnum.ANIMAL_WELFARE_FILE_PATH,volunteerID))
                OtherUtils.removedVolunteerToOrganization();
        }
    ...
    public void sortVolunteers(){
        ...
        List<Volunteer> volunteerList = activeUser.getVolunteerList();
